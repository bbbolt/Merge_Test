...
def parse_arguments(root_args):
    ...
    infer_parser.add_argument('--model_path', type=str, help='model_path', default=root_args.kas_checkpoint_path)
    infer_parser.add_argument('--base_url', type=str, help='server_URL', default=root_args.base_url)
    infer_parser.add_argument('--local_data_path', type=str, help='json_data_path', default=rf"{root_args.src_path}\cases\val_all_2k_eval_orig.json")
    infer_parser.add_argument('--infer_result_save_path', type=str, help='infer_result_save_path', default=rf"{root_args.src_path}\infer_results\{root_args.src_path}")
    infer_parser.add_argument('--number_worker', type=int, help='number_worker', default=16)
    infer_parser.add_argument('--data_mapping_dict', type=str, help='data_mapping_dict', default=root_args.data_mapping_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--device_default_change', action='store_false', help='Flag to change device defaults. Just execute once!!')
    ...
    # Src Path
    parser.add_argument('--src_path', type=str, help='src_path', default=r"val_all_2k_eval_infer_result.json")
    args = parser.parse_args()

    infer_args, val_args = parse_arguments(args)
