...
''',
"pvt_get_context": """function PivotInitialize(context, task)
{
    const pvt = context.RequirePivotTable()
...
"TrimmedHeaderRange":'''function TrimmedHeaderRange(range)
{
    ...
    if (lcol > cols && rcol == 1) {
    	return range.Offset(1, 0).Resize(rows - 1, cols)
    }
...
''',
"IlleagalBooleanParameter":'''function IlleagalBooleanParameter(param)
{
    if (undefined == param || 'boolean' != typeof(param))
        return true
...
# 工具函数和对应依赖函数列表
PVT_DATA_MAPS = {
    "PivotCreate": ["ParseCellRange", "GetXlPivotFilterType", "GetSheetByName", "PivotCreatePivotTable", "IllegalBooleanParameter", "PivotAddFilter", "PivotGetPivotField",
                    "GetNameWithColumn", "GetEnableName", "GetCountOfPivotField", "IsDateTypeValue", "CalculateSimilarity", "PivotAddRowField", "PivotAddFieldToArea", "PivotCreate", 
                    "TrimmedHeaderRange", "IllegalStringParameter", "GetBestMatchString", "ExtractColumnString", "pvt_get_context"],
    "PivotGetPivotField": ["ParseCellRange", "GetXlPivotFilterType", "GetSheetByName", "PivotCreatePivotTable", "IllegalBooleanParameter", "PivotAddFilter", 
                           "PivotGetPivotField", "GetNameWithColumn", "GetEnableName", "GetCountOfPivotField", "IsDateTypeValue", "CalculateSimilarity", "PivotAddRowField", "PivotAddFieldToArea", "PivotCreate", "TrimmedHeaderRange", "IllegalStringParameter", "GetBestMatchString", "ExtractColumnString", "pvt_get_context"],
    "pvt_get_context": ["pvt_get_context"],
    "PivotAddRowField": ["PivotAddRowField", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", 
                         "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotRepeatAllLabels": ["IlleagalBooleanParameter", "PivotRepeatAllLabels"],
    "PivotSubtotal": ["PivotSubtotal"],
    "PivotSelect": ["GetXlPTSelectionModeType", "PivotSelect"],
    "PivotDisplayFieldCaptions": ["IlleagalBooleanParameter", "PivotDisplayFieldCaptions"],
    "PivotClearAllFilters": ["PivotClearAllFilters"],
    "PivotClearTable": ["PivotClearTable"],
    "PivotDelete": ["PivotDelete"],
    "GetBestMatchString":["GetBestMatchString"],
    "PivotShowTableFieldList": ["PivotShowTableFieldList", "IlleagalBooleanParameter"],
    "PivotShowDrillIndicators": ["PivotShowDrillIndicators", "IlleagalBooleanParameter"],
    "PivotAddCalculatedItemsField": ["PivotAddCalculatedItemsField", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString",
                                     "GetNameWithColumn", "CalculateSimilarity", "getRange", "GetCountOfPivotField", "GetBestMatchString"],
    "PivotAddSlicer": ["PivotAddSlicer", "AddSlicerToPivotTable","AddSlicerToCache", "GetEnableItemName", "PivotGetPivotField", "IllegalStringParameter", 
                       "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "CalculateSimilarity", "getRange", "GetCountOfPivotField", "GetBestMatchString"],
    "PivotAddBlankLine": ["PivotAddBlankLine", "IlleagalBooleanParameter", "GetCountOfPivotField"],
    "PivotTotalDisplay": ["PivotTotalDisplay", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", "GetNameWithColumn", 
                          "CalculateSimilarity", "getRange", "GetCountOfPivotField", "GetBestMatchString"],
    "PivotValueFieldGroup": ["PivotValueFieldGroup", "PivotFieldGroup", "PivotAddRowField", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", 
                             "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotCalculateOfPercent":["PivotCalculateOfPercent", "PivotAddDataField", "GetXlSummaryType", "IsDateTypeValue", "PivotAddFieldToArea", "PivotGetPivotField", 
                               "IllegalStringParameter", "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotAddCalculatedField": ["PivotAddCalculatedField"],
    "PivotReportLayout": ["PivotReportLayout", "GetXlLayoutRowType"],
    "PivotAddColumnField": ["PivotAddColumnField", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", 
                            "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotAddFilterField": ["PivotAddFilterField","PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", "GetEnableItemName", "GetEnableName", 
                            "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange", "ContentFilter"],
    "PivotDateFieldGroup": ["PivotDateFieldGroup", "PivotFieldGroup", "PivotAddRowField", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", 
                            "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotAddDataField": ["PivotAddDataField", "GetXlSummaryType", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", 
                          "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotAddFilter": ["PivotAddFilter", "PivotAddRowField", "PivotAddFieldToArea", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", 
                       "GetNameWithColumn", "GetCountOfPivotField", "GetBestMatchString",  "CalculateSimilarity", "getRange", "GetXlPivotFilterType", "IsDateTypeValue"],
    "PivotMove": ["PivotMove", "ParseCellRange"],
    "PivotMoveField": ["PivotMoveField", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField",
                       "GetBestMatchString",  "CalculateSimilarity", "getRange"],
    "PivotMoveItem": ["PivotMoveItem", "PivotGetPivotField", "IllegalStringParameter", "GetEnableName", "ExtractColumnString", "GetNameWithColumn", "GetCountOfPivotField", 
                      "GetBestMatchString",  "CalculateSimilarity", "getRange", "GetEnableItemName"],
    "GetBestMatchString": ["IllegalStringParameter", "GetBestMatchString", "CalculateSimilarity"]
