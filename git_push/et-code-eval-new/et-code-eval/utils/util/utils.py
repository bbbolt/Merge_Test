...
from utils.util.multi_sheet.functions import MULTI_SHEET_FUNCTIONS
...
def add_functions(code, model_input):
    extra_function_tool = ""
    functions = {}
    context = ''
    ...
    if "HYBERLINK_" in code:
        try:
            ...
            # print(code)
            pass
    if "CLOP_" in code or "FindReplaceColor" in code or "doBeautify" in code:
    ...
    if "GetMultiSheet" in code or 'SplitMultiRangeIntoList' in code:
        ...
        try:
            ...
            functions_used = re.findall(pattern, functions_used)
            for function in functions_used:
                if function in MULTI_SHEET_FUNCTIONS:
                    functions[function] = MULTI_SHEET_FUNCTIONS[function](MULTI_SHEET_FUNCTIONS["get_tables"](model_input), code)
