...
""",
"hyp_get_context":"""function hyp_get_context(task)
{
    let targetWorksheet = ActiveSheet
    let targetWorkbook = ActiveWorkbook
...
# 工具函数和对应依赖函数列表
HYBERLINK_MAPS = {
    "HyberLinkInsert": ["HyberLinkInsert", "GetHyberLinkSelRange", "GetHyberLinkSheet", "findRangeByContent", "GetActiveRange", "hyp_get_context"],
    "HyberLinkDelete": ["GetHyberLinkSheet", "GetHyberLinkSelRange", "HyberLinkDelete", "GetActiveRange", "hyp_get_context"],
    "HyberLinkOpen": ["HyberLinkOpen", "GetHyberLinkSelRange", "GetHyberLinkSheet", "GetActiveRange", "hyp_get_context"],
    "hyp_get_context": ["hyp_get_context"]
}