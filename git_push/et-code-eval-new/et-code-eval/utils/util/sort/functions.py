...
function sort_get_context(task)
{
    let context = 
    {
...
"sort_get_context":"""function sort_get_context(task)
{
    let context = 
    {
        RequireSort: function()
...
# 工具函数和对应依赖函数列表
SORT_MAPS = {
    "SortCreateCustomList": ["FindCustomList", "SortAddSortField", "GetIDByTrafficLight", "IsArrow5", "GetIDByArrow", "GetRangeTexts", "GetTableStructsOfRange", "SortApply", "SortCreateCustomList", "DistanceOf", "getRange", "CheckColorIsInRange", "IsArrow3", "rgb2hsv", "GetSortIcon", "GetTableRangeFromKey", "IsArrow4", "GetActiveRange", "sort_get_context"],
    "SortAddSortField": ["DistanceOf", "GetIDByTrafficLight", "IsArrow4", "GetIDByArrow", "IsArrow5", "GetTableStructsOfRange", "GetSortIcon", "SortAddSortField", "getRange", "SortApply", "IsArrow3", "GetTableRangeFromKey", "CheckColorIsInRange", "rgb2hsv", "GetActiveRange", "sort_get_context"],
    "sort_get_context" : ['sort_get_context']
}